...
jQuery(document).ready(function(){
  ...
  function showElement(id){
    ...
    $(document).trigger("fieldset:shown", jQuery('#' + id));
  }
  ...
  function hideElement(id){
    ...
    $(document).trigger("fieldset:hidden", jQuery('#' + id));
  }
  ...
  jQuery(document).on("click", 'input.exclusive:checkbox', function(){
    var e = $(this);
  ...
  $(document).on("change", ".surveyor_language_selection select#locale", function(){
    this.form.submit(); 
  });
});
